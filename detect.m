...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% im = imread("test_1.jpg");
% imgray = rgb2gray(im);
% imbin = imbinarize(imgray);
% im = edge(imgray, 'prewitt');
% 
% 
% % im = imclose(im, ones(3));
...
im = imresize(double(imread('img/done/4.jpg'))/255, [1000 NaN]);
im = rgb2gray(im);
% figure imshow(im);
% figure imhist(im);
...
stats = regionprops(im_fill2,'BoundingBox', 'Orientation', 'EulerNumber');
imshow(im_fill2);
% im_masked = im;
